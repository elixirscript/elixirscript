...
let SpecialForms = {
  ...
  bound: function (_var) {
    return undefined(_var);
  },

  _case: function (condition, clauses) {
    return undefined(...clauses)(condition);
  },
...
Kernel.defimpl(Chars$1, Core.Tuple, {
  to_string: function (thing) {
