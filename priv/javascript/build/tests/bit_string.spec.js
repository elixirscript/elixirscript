...
describe('BitString', function () {
  ...
  describe('creation', function () {
    it('create properly', function () {
      var bs = BitString(BitString.integer(1));
