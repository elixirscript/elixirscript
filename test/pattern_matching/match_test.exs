...
#    params = [{:_, [], Test}]
#    result = Match.build_match(params, ElixirScript.Translator.Env.module_env(ElixirScript.Temp, "temp.ex") )
...
#    expected_result = {
#      [Match.type(JS.identifier(:Hello), JS.object_expression([
#          Map.make_property(Translator.translate!(:key, ElixirScript.Translator.Env.module_env(ElixirScript.Temp, "temp.ex") ), Match.parameter)
#        ]))
#      ],
#      [JS.identifier("key")]
#    }
